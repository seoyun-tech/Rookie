    ...
    <footer className={twMerge('w-full bg-gray-50', className)}>
      <div className="max-w-[1280px] mx-auto px-6 md:px-10 py-6 md:py-0 md:h-[172px] flex flex-col md:flex-row md:items-center gap-6 md:gap-0 md:justify-between">
        ...
        <div className="flex flex-wrap gap-x-8 gap-y-2 md:gap-12">
          <a href="#" className="text-sm text-gray-400 font-medium hover:text-gray-600">이용약관</a>
          <a href="#" className="text-sm text-gray-400 font-medium hover:text-gray-600">개인정보처리방침</a>
          <a href="#" className="text-sm text-gray-400 font-medium hover:text-gray-600">자녀 보호 설정</a>
          <a href="#" className="text-sm text-gray-400 font-medium hover:text-gray-600">고객센터</a>
        </div>
