...
export default function DetailPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="w-full max-w-[1280px] mx-auto px-6 py-10 flex flex-col gap-12">
        {/* Back Button */}
        <button
          onClick={() => navigate(-1)}
          className="w-fit flex items-center gap-2 text-primary-600 font-black text-2xl hover:scale-105 transition-transform"
        >
        ...
        <section className="flex flex-col lg:flex-row gap-12 items-center lg:items-start">
          <div className="w-[400px] shrink-0 rounded-[60px] overflow-hidden shadow-2xl border-8 border-primary-100">
            <img
          ...
          <div className="flex flex-col gap-8 flex-1">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-center gap-6 text-2xl font-bold text-gray-500">
                <div className="flex items-center gap-2 text-yellow-500 bg-yellow-50 px-4 py-2 rounded-full">
                  <FontAwesomeIcon icon={faStar} />
                  <span>{movie.vote_average?.toFixed(1)}</span>
                </div>
                <div className="flex items-center gap-2 bg-blue-50 px-4 py-2 rounded-full text-blue-500">
            ...
            <div className="bg-gray-50 p-10 rounded-[48px]">
              <h3 className="text-3xl font-black text-primary-700 mb-4">
                어떤 이야기인가요?
              </h3>
              <p className="text-2xl font-medium text-gray-700 leading-relaxed break-keep">
        ...
        {trailer && (
          <section className="flex flex-col gap-6">
            <h2 className="text-4xl font-black text-gray-900 border-l-[12px] border-primary-500 pl-6">
              미리보기 영상
            </h2>
            <div className="w-full aspect-video rounded-[60px] overflow-hidden shadow-xl border-4 border-gray-100 bg-black">
              <ReactPlayer
